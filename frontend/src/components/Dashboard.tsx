...
import { updateNotes{note_id}, deleteNotes{note_id}, createNotes, login, createRegister, register, createLogin, createPassword-reset, getNotes, logout } from './services/api';
